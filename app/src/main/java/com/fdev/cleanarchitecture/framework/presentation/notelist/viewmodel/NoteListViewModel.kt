package com.fdev.cleanarchitecture.framework.presentation.notelist.viewmodel
...
import com.fdev.cleanarchitecture.business.interactors.notelist.DeleteMultipleNotes.Companion.DELETE_NOTES_YOU_MUST_SELECT
import com.fdev.cleanarchitecture.business.interactors.notelist.NoteListInteractors
import com.fdev.cleanarchitecture.framework.datasource.cache.database.NOTE_ORDER_DESC
import com.fdev.cleanarchitecture.framework.datasource.database.NOTE_FILTER_DATE_CREATED
import com.fdev.cleanarchitecture.framework.datasource.preferences.PreferenceKeys.Companion.NOTE_FILTER
import com.fdev.cleanarchitecture.framework.datasource.preferences.PreferenceKeys.Companion.NOTE_ORDER
import com.fdev.cleanarchitecture.framework.presentation.common.BaseViewModel
import com.fdev.cleanarchitecture.framework.presentation.notelist.state.NoteListInteractionManager
    ...
    override fun setStateEvent(stateEvent: StateEvent) {
        val job: Flow<DataState<NoteListViewState>?> = when(stateEvent){
            ...
            is NoteListStateEvent.GetNumNotesInCacheEvent -> {
                noteListInteractors.getNumberOfNotes.getNumNotes(
                    stateEvent = stateEvent
                )
            }
